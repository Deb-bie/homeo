  ...
  return (
    <div className="w-[100%] h-full flex overflow-hidden ">
        <div className="w-[100%] h-full flex flex-col flex-nowrap content-center items-start ">
            ...
            {/* When there is something inside favorites */}
            ...
            <div className="py-24 px-4 sm:px-12 w-[100%] h-full flex flex-col justify-between items-start content-center ">
                ...
                <div className="outline-none border-[1px] border-b-gray-500 border-t-transparent border-x-transparent 4xs:py-4 sm:py-6 4xs:px-2 sm:px-6 w-[100%] h-[100%]  flex flex-row justify-between content-center items-center overflow-hidden ">
                    ...
                    <div className="4xs:px-0 xs:px-4 lg:px-12 4xs:py-0 xs:py-2 lg:py-8 gap-2 w-[30%] flex 4xs:flex-col sm:flex-row 4xs:justify-start  sm:justify-between content-center 4xs:items-start sm:items-center ">
                        ...
                        <button className="flex py-2 4xs:px-4 lg:px-8 bg-black text-white text-[12px] sm:text-base lg:text-xl">Buy</button>
                    </div>

                    <div className="w-[5%] flex justify-center items-end content-center text-2xl cursor-pointer">
                        <IoMdClose />
                    </div>
                </div>

                <div className="4xs:py-4 sm:py-6 4xs:px-2 sm:px-6 w-[100%] h-[100%] flex flex-row justify-between content-center items-center overflow-hidden ">
                    
                    <div className="gap-4 w-[30%] flex 4xs:flex-col sm:flex-row 4xs:justify-center sm:justify-between 4xs:items-start sm:items-center content-center ">
                        
                        <div className="flex 4xs:w-[30px] 2xs:w-[100px] xs:w-[150px] h-auto sm:w-[40%] sm:h-[100px] 4xs:justify-center 4xs:content-center 4xs:items-center  " >
                            <img src={Image1} className=" w-[100%] object-contain " />
                        </div>

                        <div className="4xs:w-full sm:w-[150px] inline-block overflow-hidden text-ellipsis">
                            bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
                        </div>
                    </div>
                    ...
                    <div className="w-[5%] flex justify-center items-end content-center text-2xl">
                        <IoMdClose />
                    </div>
                ...
                <div className="w-[100%] flex flex-row justify-end mt-12">
                    <button className="flex bg-black text-white py-2 px-6 hover:bg-white hover:text-black hover:border-black hover:border-2  ">Clear Wishlist</button>
                </div>
            </div>
        </div>
    </div>
