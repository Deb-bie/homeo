                                ...
                                id === 1 ? 
                                    <div className="px-6 mb-24 4xs:gap-8 sm:gap-0 w-[100%] h-full flex flex-col-reverse sm:flex-row flex-wrap justify-evenly content-center items-center">
                                        <div className="4xs:w-full sm:w-[40%] h-full flex flex-col flex-wrap 4xs:justify-stretch sm:justify-center content-center items-start" >
                                            ...
                                            <h1 className="text-5xl font-bold hover:text-red-900">{featuredProduct.productName}</h1>
                                            <p className="w-[80%] flex my-8">{featuredProduct.productDescription}</p>
                    
                                            <button onClick={() => handleDescription(1)} className="border-2 border-black py-2 px-4 transform transition duration-500 hover:bg-black hover:text-white ">
