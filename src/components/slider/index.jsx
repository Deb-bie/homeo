        ...
        <div className="flex flex-row items-center justify-between h-full w-full" >
...

            {
                SliderData.map((slide, i) => {
                    return (
                        <div className={i === currentSlide ? "w-[100%] h-[600px] flex justify-between md:px-12 4xs:px-0 4xs:overflow-hidden" : "hidden" }  key={i}>
                            {
                                i === currentSlide 
                                ? 
                                    <div className="relative flex flex-row flex-nowrap w-full h-full items-center justify-between overflow-hidden ">
                                        <div className="head relative flex flex-col items-start text-start justify-start 4xs:w-[100%] 2xs:w-[60%] xs:w-[50%] z-20 px-6 ">
                                            ...
                                            <br />
                                            <h1 className="ani2 slide-up2 flex flex-col flex-wrap text-2xl lg:text-6xl font-black text-black">{slide.title}</h1>
                                            <br />
                                            <p className="ani3 slide-up3 flex flex-col flex-wrap text-base  w-[80%]">{slide.desc}</p>
                                            <br />
                                            <div className="ani4 slide-up4">
                                                <button onClick={()=>navigate("/products")} className=" bg-black text-white px-8 py-4 ">SHOP NOW</button>
                                            </div>
